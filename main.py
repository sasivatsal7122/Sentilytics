...
def scrape_channel(scanID: str = Query(..., description="Scan ID"),
                         channelUsername: str = Query(..., description="Channel Username")):
    """
    Endpoint to scrape channel information.
    """
    try:
        insert_scan_info(scan_id=scanID, channel_id="channelID", phase='scrape_channel', is_start=True)
    except:
...
def get_hlcomments(scanID: str = Query(..., description="Scan ID"),
                         channelID: str = Query(..., description="Channel ID")):
    """
    Endpoint to get high-level comments.
    """
    insert_scan_info(scan_id = scanID,channel_id=channelID, phase='scrape_hlcomments',is_start=True)
...
def perform_sentilytics(scanID: str = Query(..., description="Scan ID"),
                              channelID: str = Query(..., description="Channel ID")):
    """
    Endpoint to perform sentiment analysis on comments.
    """    
    insert_scan_info(scan_id = scanID, channel_id=channelID, phase='perform_sentilytics',is_start=True)
...
def perform_youtube_ranker_route(scanID: str = Query(..., description="Scan ID"), videoID: str = Query(..., description="Video ID"), keyword: str = Query(..., description="Keyword")):
    """
    Endpoint to perform YouTube ranking.
    """
    insert_scan_info(scan_id = scanID,channel_id=videoID, phase='perform_youtube_ranker',is_start=True)
...
@router.get("/cvstats/")
def scrape_cvStats( scanID: str = Query(..., description="Scan ID"),
                         channelID: str = Query(..., description="Channel ID")):
    """
...
def scrape_cvStats(scanID: str = Query(..., description="Scan ID"),channelID: str = Query(..., description="Channel ID")):
    """
    Endpoint to make data replication for a given scan/Scan id.
    """
    insert_scan_info(scan_id = scanID,channel_id=channelID, phase='make_replica',is_start=True)
...
def getChannel_info(scanID: str = Query(..., description="Scan ID")):
    """
...
def getChannel_info(channelID: str = Query(..., description="Channel ID")):
    """
...
def getMonthly_stats(channelID: str = Query(..., description="Channel ID")):
    """
...
def getVideo_stats(channelID: str = Query(..., description="Channel ID")):
    """
...
def getEmoji_stats(channelID: str = Query(..., description="Channel ID")):
    """
